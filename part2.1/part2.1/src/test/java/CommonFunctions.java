...
public class CommonFunctions {
    ...
    public void clickAndCheckErrorMessage(By errorLocator, String expectedXPath) {
        // Nhấn vào phần tử chứa thông báo lỗi
        clickElement(errorLocator);

        // Kiểm tra xem thông báo lỗi có khớp với XPath mong đợi hay không
        WebElement errorElement = driver.findElement(By.xpath(expectedXPath));
        if (errorElement.isDisplayed()) {
            System.out.println("Thông báo lỗi khớp với XPath mong đợi.");
        } else {
            throw new AssertionError("Thông báo lỗi không khớp với XPath mong đợi.");
        }
    }
